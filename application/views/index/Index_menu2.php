      ...
      <div class="accordion-inner">
        <ul class="nav nav-list">
			<li class="active"><?php echo anchor("/git/gitshowapply/","git认证申请","target=index_center");?></li>
 			...
 			<li><?php echo anchor("/git_level/index/","审批git认证" ,'target=index_center')?></li>
 			<li><?php echo anchor("/git_ops/index/","运维git认证审批" ,'target=index_center')?></li>
 			<li><?php echo anchor("/git/alllist/","git认证管理","target=index_center");?></li>
 			<li><?php echo anchor("/git_ops/git_total/","git认证操作统计","target=index_center");?></li>
 			<li class="divider"></li>
 			 <li><?php echo anchor("/gitgroups"," git组添加","target=index_center");?></li>
 			<li><?php echo anchor("/grouplevel/alllist","审批git组","target=index_center");?></li>
