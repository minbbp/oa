...
<div class="control-group pull-left">
    ...
    <div class="controls">
      <input type="text" id="m_name" name="m_name"  value="<?php echo $m_rs['m_name']?>" placeholder="模块名称">
 ...
 <div class="control-group pull-left">
    ...
    <option value='0' <?php if($m_rs['m_type']==0){echo "selected";}?>>线下模块</option>
    <option value='1' <?php if($m_rs['m_type']==1){echo "selected";}?>>线上模块</option>
    </select>
    <span class="help-inline"></span>
    </div>
 </div>
...
<div class="clearfix"></div>
 ...
 <div class="control-group pull-left">
    ...
    <div class="controls">
      <textarea rows="6" class="span7" id="m_server" name="m_server" placeholder="多个ip请使用逗号进行分割"><?php $str="";foreach($server_rs as $s){$str.=long2ip($s['server_ip']).",";}echo substr($str,0,-1);?></textarea>
 	 <span class="help-inline"></span>
 	</div>
 </div>
 <div class="clearfix"></div>
