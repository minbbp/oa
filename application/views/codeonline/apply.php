...
<div class="control-group ">
    ...
    <div class="controls">
      <input type="text" id="required_id" name="require_id" value="<?php echo $required_no?>" placeholder="请输入需求关键字">
 ...
 <div class="control-group ">
    ...
    <div class="controls">
       <input type="text" id="git_url" name="git_url" value="<?php echo $required_no?>" placeholder="源码git地址">
    <span class="help-inline"></span>
    </div>
 </div>
 <div class="control-group ">
    ...
    <div class="controls">
     <input type="text" id="git_tag" name="git_tag" value="<?php echo $required_no?>" placeholder="git标签">
    <span class="help-inline"></span>
    </div>
 </div>
  <div class="control-group">
...
<div class="clearfix"></div>
 ...
 <div class="control-group " style="margin-top:20px">
    ...
    <div class="controls">
      <select class="span2" name="test_id">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <textarea  id="online_description" class="span5" rows="5" name="online_description"><?php echo $re_description;?></textarea>
    <span class="help-inline"></span>
    </div>
 </div>
<div class="control-group">
