...
$(function(){
				 ...
				 $("#add_key").click(function()
				{
						/*$html='<div class="control-group">'+$('.show3').html()+'</div>'
						$('#add_key_content').append($html);*/
	                 $html='<div class="control-group">'+"<div class='control-group show3'><label class='control-label' for='gitpub'>ssh-key:</label><div class='controls'><textarea id='gitpub'  name='gitpub[]' rows='5' class='m_gitpub span5' ></textarea><span class='icon16 icon_decline del'></span></div></div>"+'</div>'
					$('#add_key_content').append($html);
	             });
	               /*更改添加*/
	              /*新添加*/
